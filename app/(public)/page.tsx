...
export default function HomePage() {
  ...
  return (
    <main className="container">
      ...
      {/* クイズ選択 */}
      <Card>
        <h2 style={{ marginBottom: 16 }}>学習を始める</h2>
        <Button variant="main" onClick={() => router.push("/select-mode?group=jlpt&industry=care")}>日本語検定を学ぶ</Button>
        <Button variant="success" onClick={() => router.push("/select-mode?industry=care")}>介護を学ぶ</Button>
        <div style={{ marginTop: 10, fontSize: 12, color: "#6b7280", lineHeight: 1.6 }}>※ 日本語検定と介護教材だけに絞った版です。</div>
      </Card>

              ...
              <div>
                ...
                <div className="mt-8 grid gap-3 sm:flex sm:flex-row">
                  <Link
                    ...
                    className="btn-primary min-h-[56px] w-full sm:w-auto sm:min-w-[190px]"
                  >
                ...
                <div className="mt-5 flex flex-wrap gap-4 text-sm font-medium text-slate-600">
                  <span>スマホ対応</span>
          ...
          <div className="mx-auto max-w-7xl px-4 py-14 md:px-6 md:py-20">
            ...
            <div className="mt-10 grid gap-4 md:grid-cols-3">
              {[
                [
                  "スマホで学習",
                  "通勤中やすきま時間でも取り組みやすい、スマホ中心の見やすい画面設計です。",
                ],
                [
                  "日本語検定・介護学習",
                  "基礎から反復しながら、段階的に学習できます。学習と模擬試験を行き来しやすい構成です。",
                ],
                [
                  "企業管理に対応",
                  "学習者一覧、正答率、最終学習日などを確認でき、フォローの判断がしやすくなります。",
                ],
              ].map(([title, text]) => (
                <div
                  key={title}
              ...
              <div className="flex h-full flex-col rounded-3xl border border-slate-200 bg-white p-7 shadow-sm">
                ...
                <div className="mt-auto pt-8">
                  <div className="grid gap-3 sm:grid-cols-2">
                    <Link
                      href={loggedIn ? "/home" : "/register"}
                      className="btn-primary min-h-[56px] w-full"
                    >
                      {loggedIn ? "個人ホームへ" : "個人で始める"}
                    </Link>
                    ...
                    <Link
                      href="/select-mode"
                      className="btn-secondary min-h-[56px] w-full"
                    >
                      学習メニューを見る
                    </Link>
                  </div>
              ...
              <div className="flex h-full flex-col rounded-3xl border border-slate-200 bg-white p-7 shadow-sm">
                ...
                <div className="mt-auto pt-8">
                  <div className="grid gap-3 sm:grid-cols-2">
                    <Link
                      href="/for-business"
                      className="btn-dark min-h-[56px] w-full"
                    >
                      法人導入を見る
                    </Link>
              ...
              {[
                ...
                >
                  ...
                  <div className="mt-6 space-y-4">
                    {block.items.map(([num, title, text]) => (
                      <div
                        key={num}
                        className="flex gap-4 rounded-2xl border border-slate-200 bg-white p-4"
                      >
                        <div
                          className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-full ${block.color} text-sm font-bold text-white`}
                        >
                          {num}
                        </div>
                        <div>

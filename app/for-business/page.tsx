            ...
            <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
              <div>
                ...
                <div className="mt-8 grid gap-3 sm:grid-cols-2">
                  <Link
                    href="#flow"
                    className="inline-flex min-h-[56px] items-center justify-center rounded-2xl bg-slate-800 px-6 py-3 text-sm font-bold text-white shadow-md transition hover:bg-slate-900"
                  >
                    お問い合わせ
                  </Link>
                  ...
                  <Link
                    href="#pricing"
                    className="inline-flex min-h-[56px] items-center justify-center rounded-2xl border border-slate-300 bg-white px-6 py-3 text-sm font-bold text-slate-900 shadow-sm transition hover:bg-slate-50"
                  >
                    概算料金を見る
                  </Link>
                </div>
                ...
                <div className="mt-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                  ...
                  <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                    <Link
                      href="/company/login"
                      className="inline-flex min-h-[54px] min-w-[190px] items-center justify-center rounded-2xl bg-slate-900 px-6 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-black"
                    >
                      管理画面ログイン
                    </Link>
                    ...
                    <Link
                      href="#flow"
                      className="inline-flex min-h-[54px] min-w-[190px] items-center justify-center rounded-2xl border border-slate-300 bg-white px-6 py-3 text-sm font-bold text-slate-900 shadow-sm transition hover:bg-slate-50"
                    >
                      導入の流れを見る
                    </Link>
                  </div>
          ...
          <div className="mx-auto max-w-7xl px-4 py-14 md:px-6 md:py-20">
            ...
            <div className="mt-10 grid gap-4 md:grid-cols-3">
              <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6">
                <h3 className="text-lg font-bold text-slate-900">学習者一覧を確認</h3>
                <p className="mt-3 text-sm leading-7 text-slate-600">
                  自社で登録した学習者を一覧で確認できます。
                  学習状況の把握がしやすくなります。
                </p>
              </div>

              <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6">
                <h3 className="text-lg font-bold text-slate-900">進捗を見える化</h3>
                <p className="mt-3 text-sm leading-7 text-slate-600">
                  学習回数、正答率、最終学習日などを見ながら、
                  フォローが必要な学習者を把握できます。
                </p>
              </div>

              <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6">
                <h3 className="text-lg font-bold text-slate-900">日本語検定取得支援に活用</h3>
                <p className="mt-3 text-sm leading-7 text-slate-600">
                  日本語検定・介護学習を日々の学習に取り入れ、
                  日本語力向上のサポートに活用できます。
                </p>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-4xl px-4 py-14 md:px-6 md:py-20">
            ...
            <div className="mt-10 space-y-4">
              {[
                [
                  "学習者は企業でまとめて管理できますか？",
                  "はい。企業担当者向けの管理画面から、学習者一覧や学習状況を確認できます。",
                ],
                [
                  "何名くらいから利用できますか？",
                  "少人数の導入から、数十名規模の運用まで想定しています。",
                ],
                [
                  "まずは相談だけでも大丈夫ですか？",
                  "はい。導入前のご相談や、運用イメージの確認だけでも問題ありません。",
                ],
                [
                  "利用料金は固定ですか？",
                  "人数や運用方法に応じてご案内するため、詳細はお問い合わせ時にご相談ください。",
                ],
              ].map(([q, a]) => (
                <div
                  key={q}
          ...
          <div className="mx-auto max-w-5xl px-4 py-16 text-center md:px-6 md:py-24">
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <a
                ...
                className="inline-flex min-w-[190px] items-center justify-center rounded-2xl bg-slate-800 px-6 py-3 text-sm font-bold text-white shadow-md transition hover:bg-slate-900"
              >
                メールで問い合わせる
              </a>
              ...
              <Link
                href="/company/login"
                className="inline-flex min-w-[190px] items-center justify-center rounded-2xl border border-slate-300 bg-white px-6 py-3 text-sm font-bold text-slate-900 shadow-sm transition hover:bg-slate-50"
              >
                企業管理画面へ
              </Link>
            </div>
